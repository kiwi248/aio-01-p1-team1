...
from favorite_map import render_favorite_map,geocode_address,get_kakao_rest_api_key
from app_pages.favorite_map import get_kakao_rest_api_key, render_favorite_map
    ...
    with st.spinner("즐겨찾기 위치를 찾는 중입니다..."):
        ...
        for favorite in favorites:
            ...
            if not location:
                ...
                try:
                    coordinates = geocode_address(location, get_kakao_rest_api_key)
